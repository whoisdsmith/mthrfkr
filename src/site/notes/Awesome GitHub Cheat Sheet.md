---
{"dg-publish":true,"permalink":"/awesome-git-hub-cheat-sheet/","dgShowBacklinks":true,"dgShowLocalGraph":true}
---
...
*Read this in other languages: [English](GitHub%20Cheat%20Sheet.md), [한국어](README.ko.md), [日本語](README.ja.md), [简体中文](README.zh-cn.md), [正體中文](README.zh-tw.md).*
...
```markdown
[ height = 100px ](%20http://www.sheawong.com/wp-content/uploads/2013/08/keephatin.gif%20)
```
